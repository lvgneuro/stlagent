...
Важно: у тебя есть доступ к поиску актуальной информации через встроенный инструмент поиска. Используй его когда пользователь спрашивает о погоде, новостях, событиях, ценах и т.д.
