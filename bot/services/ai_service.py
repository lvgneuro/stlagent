...
=== ANDREA (диваны) ===
Алессандро: модульный диван с регулируемым подголовником, электрическим реклайнером, механизм трансформации Пума, опция бельевой короб, мягкие подспинные подушки, изящная изогнутая форма подлокотника. Премиум модель.
Луиджи: диван с Г-образными опорами, мягкие элементы сиденья из 4 слоёв ППУ, встроенная полка (опция), модульная система. Без механизма трансформации.
Монако: диван в итальянском стиле, металлические опоры, механизм Венеция, шагающая спинка, шагающие подлокотники (увеличивают глубину сиденья и спальное место). Современная классика, скандинавский стиль, баухаус.
Кампус: диван с характером, хромированные опоры, декоративная молния на подлокотниках, механизм Тик-Так, опция столешница из натурального шпона.
Дэлтон: модульный диван на высоких металлических опорах, комплект подушек, для зонирования пространства и центрального места в интерьере.
Коузи (диван): модульная система для современных интерьеров, высокие современные опоры, беспроводная зарядка (опция), встроенная полка (опция), механизм SIZEZ, эксклюзивные воздушные подушки спинки и подлокотники.
Даллас: асимметричный модульный диван, выкатной механизм, бельевой короб (опция), выкатной ящик (опция), регулируемые подголовники (опция), реклайнер (опция), бар (опция), электромассажер (опция), динамика (опция). МДФ/шпон/хромированный металл опоры.
Милан: прямой диван, механизм Венеция, хромированные молдинги на боковинах, изогнутый силуэт спинки, широкие подлокотники, мягкие округлые формы, декоративная отстрочка. Опции: бельевой короб, выкатной ящик, реклайнер, электромассажер, бар. Блоки спинки и сиденья разделены для удобства посадки.
Палермо: модульный диван в стиле контемпорари, выкатной механизм, компактные габариты, заниженная высота (лёгкий, не загромождает пространство). Регулируемая глубина посадки 48-62 см, изменяющиеся спинки и сиденья. Декоративная отстрочка контрастными отделочными шнурами. Опции: бельевой короб, динамика, выкатной ящик, бар, электромассажер, электрический реклайнер, регулируемые подголовники, музыка.
Неаполь: угловой модульный диван в стиле авангард (трансформер), выкатной механизм, 8 режимов наклона спинки (можно менять выборочно на любом модуле). Широкие подлокотники (с подушкой опционально). Опоры пластиковые с прорезиненным основанием. Опции: реклайнер, динамика, бельевой короб, ящик для белья, бар, электромассажер, регулируемые подголовники, музыка, встроенный холодильник, книжный шкаф.
Марко: модульный диван для современного интерьера, механизм Пума, декор строчка Синтон 20, опоры МДФ и шпон. Съёмные подушки-валики вдоль спинки (аэропух, можно использовать под шею). Широкие сиденья, глубокая посадка, лаконичный дизайн. Опции: бельевой короб, выкатной ящик, бар.
Дюна: диван для релаксации, металлические опоры, шагающая спинка, без механизма трансформации. Плавные обволакивающие формы, уютный отдых.
Остерманн: модульный диван, механизм Easyroll, декор молдинг по периметру (декоративный — натуральное дерево или металл). Три слоя высокоэластичного ППУ HR в сиденьях. Большое разнообразие модулей: объёмные сидения, приставные, угловые, промежуточные пуфы со столешницей и без. Тумбы со столешницей и столик в коллекции. Для офиса и загородного коттеджа.
Обливион (диван): модульный диван, механизм пантограф, металлические опоры, лаконичный современный дизайн. Варианты мягкости: классический и Сенс.
Руан: модульный диван, механизм Пума, стальной декор подлокотника (разные оттенки), альтернативная спинка (низкая + пуфы + подушки), низкая модульная система (лёгкость в интерьере), плавные линии без острых углов, два слоя ППУ. Для лофт/минимализм/скандинавский.
Ноубл (диван): диван-акцент для кабинета/библиотеки/гостиной, декор "канат" на подлокотниках и спинке, хромированные подлокотники, 4 слоя ППУ в сиденье, без механизма трансформации. Опоры пластиковые с прорезиненным основанием. Каркас березовая фанера.
Бельдомо (диван): диван с механизмом Relax (приподнять и вытянуть сиденье), современный дизайн, форма сидений "пузырьки пористого шоколада", регулируемый подголовник, металлические опоры. Опции: посадка Релаксация, динамика, бар.
Эклипс: модульный диван, механизм пантограф, скрытые опоры, обтекаемый дизайн (скруглённые подлокотники и сиденье), анатомическая посадка. Варианты мягкости: классический (средней жёсткости, упругая поддержка спины) и Сенс (повышенной мягкости, обволакивающий эффект).
Нави: модульный диван, механизм Тик-Так, опоры черный металл, высокие изящные опоры, обивка Оскар 100, анатомическая посадка (подушки под анатомическим углом). Варианты: классический Нави (средней жёсткости) и Нави Сенс (повышенной мягкости, обволакивающий эффект). Плавные линии без острых углов.

=== ANDREA (кресла) ===
Космо: кресло с поворотом на 360°, каркас фанера, обивка Grass, наполнитель ППУ, опоры сталь (черные), максимальная нагрузка до 100 кг.
Отто: кресло со спинкой плавно переходящей в ножки, отстрочка нитью в тон, опоры черная эмаль, наполнитель ППУ, высота посадочного места 47 см, глубина 48 см, размеры 58×63×75 см, нагрузка до 120 кг.
Мадрид: кресло с динамичной округлой формой, двойная мягкая подушка (эффект погружения), размеры 84×85×90 см, глубина посадочного места 50 см, высота 55 см, ППУ, нагрузка до 120 кг. Для классического интерьера и шале.

=== ANDREA (кровати) ===
Бельдомо: мягкое изголовье, современный дизайн.
Империя: лаконичная форма, металлические регулируемые опоры, подъёмный механизм (опция), бельевой короб. Длина 207 см, ширина на выбор: 167/187/207 см, высота 40 см. Комбинируется со стеновыми панелями.
Лили: детская кровать, мягкие бортики по периметру (защита от ударов), подъёмный механизм, короб для хранения. Длина 200 см, ширина 80/90 см.
Тео: детская кровать, мягкие бортики, выдвижной ящик для хранения. Длина 200 см, ширина 80/90 см.

=== ANDREA (корпусная мебель и столы) ===
Ноубл (тумба): шпон американского ореха (микст сшивка), округлая форма, стальное основание черный муар, размеры 180×55×79 см.
Обливион (журнальный стол): двухъярусный, шпон, размеры 123×123×37 см, толщина столешницы 40 мм, опоры mat black.
Коузи (журнальный столик): керамогранит (имитация камня), диаметр 600 мм, толщина 10 мм, опоры металл черные.

=== ANDREA (пуфы) ===
Стоун: трапециевидная форма, каркас древесина хвойных и лиственных пород/фанера, ППУ, размер 870×650×440, нагрузка до 100 кг.
Боно: круглый дизайн, металлическое кольцо-декор, ППУ, размер 600×600×420, каркас древесина хвойных и лиственных пород.

=== ANDREA (люстры) ===
Мадрид: каркасная люстра, дерево, высота 45 см, диаметр 30/40/50 см (три размера), для сканди/эко/минимализм/современная классика.

=== ANDREA (стеновые панели) ===
Французская елка: мягкие панели с рисунком, звукопоглощающие, для жилых/офисов/общественных пространств, габариты по индивидуальному запросу.
Листовая: мягкие панели с рисунком "листовая", звукопоглощающие, габариты по индивидуальному запросу.
Плиточная: мягкие панели с рисунком "плиточная", звукопоглощающие, габариты по индивидуальному запросу.
