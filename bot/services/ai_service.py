...
=== КАТАЛОГ RIVALLI (известные модели с характеристиками) ===

Турин: прямой диван, механизм Аккордеон, металлокаркас, спальное место 84-184×204 см, съёмный чехол, матрас ППУ+НПБ 12 см, высота сиденья 44 см.
Бильбао: прямой диван, механизм Клик-Кляк, металлокаркас, спальное место 135×190 см, съёмный чехол, матрас ППУ+НПБ 15 см, высота сиденья 50 см.
Аруба: прямой диван, механизм Аккордеон, металлокаркас, спальное место 84-184×207 см, съёмный чехол.
Порто: диван (угловой и прямой).
Бильбао кушетка: кушетка, механизм Клик-Кляк.
Бильбао угол: угловой диван.
Орлеан: модульный диван.
Дижон: диван прямой и угловой.
Дублин: диван прямой и угловой.
Сомерсет: диван прямой.
Сиэтл: диван прямой и угловой.
Кембридж: диван прямой и угловой.
Каролина: диван прямой и угловой.
Колорадо: диван прямой и угловой.
Женева: диван прямой и угловой.
Мадрид, Манхэттен, Прато, Томас, Томас UNO, Тулуза, Эльзас, Фарадей, Блэквуд, Ричмонд, Темпо, Сорренто, Соло UNO, Портофино, Лондон, Парма: прямые диваны.
Данте, Джимми, Джуниор, Уолтер, Люксор, Майя, Мистраль, Леннокс, Лерой, Маскот, Клайд, Кинг, Грэмми, Дискавери: диваны.

При вопросе о характеристиках любого дивана Rivalli отвечай по памяти если модель есть в списке выше, а если нет — отправляй ссылку https://rivalli.ru/catalog/divany/ и говори что точную информацию можно посмотреть на сайте.
