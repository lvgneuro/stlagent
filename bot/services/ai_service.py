...
ТакО: кресло.
Каро: шезлонг (кресло) с коробом для белья и подъёмным механизмом.
Белл: кресло.
Бенедикт: кресло.
Бачё: кресло.
Бетвин: кресло.
...
Тэйлор: диван с механизмом "Тик-Так", шезлонг с подъёмным механизмом и газовыми упорами.
Сноф: современный диван с мягкими подлокотниками.
Портер: прямой диван с ящиком для белья.
Каро: шезлонг (левый/правый) с коробом для белья и подъёмным механизмом, с газовыми упорами.
Пол: компактный диван для небольших помещений.
Грант: большой просторный диван.
Флин: диван в английском классическом стиле.
Семмифреддо: мягкий диван с округлыми формами.
Шон Ультра: диван повышенной комфортности.
Роджер: современный диван.
Паззл: модульный диван.
Моцарт: диван в классическом стиле.
Поль: диван.
